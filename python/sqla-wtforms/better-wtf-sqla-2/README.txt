!!!This one is a super basic Jinja template that contians a loginform and uses posgres and SQLAlchemy so that the database can be used throughout as an object. 
